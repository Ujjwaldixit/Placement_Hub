        ...
        <div class="container">
            <div class="forms-container">
                <div class="signin-signup">
                    <form action="studentLoginServ" class="sign-in-form">
                    ...
                    <form action="studentregister" class="sign-up-form">
                        <h2 class="title up">Sign up</h2>
                        <div class="input-field">
                            <i class="fas fa-user"></i>
                        ...
                        <div class="input-field">
                            <i class="fas fa-book-reader"></i>
                            <input type="text" oninput="this.value = this.value.toUpperCase()" placeholder="depart" name="depart">
                        </div>
                        <div class="input-field">
                        ...
                        <input type="submit" class="btn md-50" value="Sign up" />
            ...
            <div class="panels-container">
                <div class="panel left-panel" id="register">
                    <div class="content">
                        <h3>New here ?</h3>
                        <p>
                            Click the below Button to Sign-Up
                        </p>
