        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <section class="container card-shadow">
                ...
                <div class="right-section">
                    <img class="" src="AdminImages/<%=admin.getProfile_pic()%>" alt="student">
                </div>
            </section>
