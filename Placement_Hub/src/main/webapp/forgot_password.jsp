<%-- 
    ...
    Created on : 12-Mar-2021, 9:01:53 pm
    Author     : ASUS
--%>
...
<html lang="en">
    ...
    <body>
        <main>
            ...
            <div class="section2">
                <div class="card">
                    <h1 class="heading">Verify your E-mail</h1>
                    <p class="msg">Please enter the e-mail with whose your account is associated</p>
                    
                    <form action="enterOtp.jsp">
                        <input type="text" class="email" name="email" placeholder="Enter your Email Address">
