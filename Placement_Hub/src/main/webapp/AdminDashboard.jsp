    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <%                StudentDao StudentDao = new StudentDao(connection_provider.getconnection());
                ...
                String totalStudentcount = StudentDao.totalStudentsCount();
                String totalPlacedStudentcount = StudentDao.totalPlacedStudentsCount();
                String totalWebinarCount = getWebinarDao.totalsWebinarCount();
                String totalDrivesCount = drivesDao.totalDrivesCount();
            %>
            <div class="w3-row-padding w3-margin-bottom">
                ...
                <div class="w3-quarter">
                    <a href="placedStudents.jsp" style="text-decoration: none">
                        <div class="w3-container w3-blue w3-padding-16">
                            <div class="w3-left"><i class="fa fa-eye w3-xxxlarge"></i></div>
                            <div class="w3-right">
                                <h3><%=totalPlacedStudentcount%></h3>
                            </div>
                            <div class="w3-clear"></div>
                ...
                <div class="w3-quarter">
                    <a href="webinar.jsp" style="text-decoration:none">
                        <div class="w3-container w3-teal w3-padding-16">
                            <div class="w3-left"><i class="fa fa-share-alt w3-xxxlarge"></i></div>
                            <div class="w3-right">
                                <h3><%=totalWebinarCount%></h3>
                            </div>
                            <div class="w3-clear"></div>
                            <h4>Webinars</h4>
                        </div>
                ...
                <div class="w3-quarter">
                    <a href="placementDrives.jsp" style="text-decoration:none">
                        <div class="w3-container w3-orange w3-text-white w3-padding-16">
                            <div class="w3-left"><i class="fa fa-users w3-xxxlarge"></i></div>
                            <div class="w3-right">
                                <h3><%=totalDrivesCount%></h3>
                            </div>
                            <div class="w3-clear"></div>
                            <h4>Drives On Going</h4>
                        </div>
                    </a>
                </div>
